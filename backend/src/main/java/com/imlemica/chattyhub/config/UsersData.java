...
public class UsersData {
    ...
    public void addUsers(){
        ...
        userService.saveUser(AppUser.builder().name("admin").roles(roleList).password("admin").build());
        userService.saveUser(AppUser.builder().name("user").roles(roleList).password("user").build());
        userService.saveUser(AppUser.builder().name("kseni").roles(roleList).password("kseni").build());
    }
}
